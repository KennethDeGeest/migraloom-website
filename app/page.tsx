...
export default function Home() {
  return <main>
    <nav className="nav-shell" aria-label="Main navigation"><Wordmark/><div className="nav-links"><a href="#how">How it works</a><a href="#inside">Inside the app</a><Link href="/privacy">Privacy</Link></div><a className="nav-cta" href="#offer">Get early access</a></nav>

    <section className="hero" id="top">
      <div className="hero-copy"><p className="eyebrow"><span/>Private migraine journal for iPhone</p><h1>Your migraine story, <em>ready when your appointment is.</em></h1><p className="hero-text">Capture the essentials in seconds. MigraLoom turns scattered episodes into a calm timeline and a visit-ready summary—without sending your journal to the cloud.</p><div className="hero-actions"><a className="primary-button" href="#offer">Join early access <b>→</b></a><a className="text-link" href="#inside">See the real app</a></div><div className="proof-row"><span><b>Seconds</b> to start</span><span><b>No account</b> required</span><span><b>On-device</b> journal</span></div></div>
    ...
    <section className="offer" id="offer"><div className="offer-copy"><p className="eyebrow light">Coming soon on iPhone</p><h2>One calm place for the story your memory should not have to carry.</h2><p>Start with the basics. Add detail only when it helps. Bring the result to the moments where clarity matters.</p><ul><li><b>Fast episode capture</b><span>Begin with just time and intensity</span></li><li><b>Timeline and pattern views</b><span>See what happened without decoding a spreadsheet</span></li><li><b>Visit-ready PDF</b><span>Prepare a useful summary before an appointment</span></li><li><b>Private, on-device journal</b><span>Your health notes are not an advertising profile</span></li></ul></div><div className="price-card"><p>Founding launch plan</p><div className="price"><span>$</span>29.99<small>/ year</small></div><p className="trial">7 days free · Cancel anytime in Apple settings</p><a className="primary-button coral" href="mailto:hello@migraloom.com?subject=MigraLoom%20early%20access">Join early access <b>→</b></a><small>Monthly option planned at $4.99. Final App Store pricing may vary by region.</small></div></section>
